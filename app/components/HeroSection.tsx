...
function HeroSection() {
  return (
    <section className="container mx-auto p-8 h-fit w-full text-center flex items-center flex-col space-y-12">
      <Link
        className="rounded-2xl bg-orange-500 text-background px-4 py-1.5 text-sm sm:text-base font-semibold"
        target="_blank"
        href="/"
      >
      ...
      >
        ...
        <Button
          variant="ghost"
          className="w-36 h-14 sm:w-44 sm:h-18 text-orange-500 hover:text-background outline hover:outline-orange-500 hover:bg-orange-500 transition-colors"
        >
          Video
        </Button>
      </div>
