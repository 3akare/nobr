...
function Features() {
  ...
  return (
    <section
      className="p-4 h-fit w-full flex flex-col items-center text-center space-y-6"
      id="features"
    >
      <h2 className="font-semibold text-3xl leading-[1.1] sm:text-3xl md:text-6xl">
        Features
      </h2>
      <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-md text-sm sm:leading-8">
